# coding=utf-8
"""Implementation of SAEA-TIM Attack."""
...
tf.flags.DEFINE_integer('m_saea', 20, 'hyper-parameter of saea, inner iterative number')
            ...
            for filenames, images in load_images(FLAGS.input_dir, batch_shape):
                ...
                for i in range(num_iter):
                    ...
                    for j in range(m_saea):
                        ...
                        grad_single = np.random.choice([grad_inc_v3, grad_inc_res, grad_res_v2])
                        ...
                        noise_ensemble = (noise_inc_v3 + noise_inc_res + noise_res_v2) / 3
                        ...
                        grad_inner = grad_inner + noise_ensemble
