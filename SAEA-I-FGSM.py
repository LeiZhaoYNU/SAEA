# coding=utf-8
"""Implementation of SAEA-I-FGSM Attack."""
...
tf.flags.DEFINE_integer('m_saea', 20, 'The inner iterative number of saea.')
            ...
            for filenames, images in load_images(FLAGS.input_dir, batch_shape):
                ...
                for i in range(num_iter):
                    ...
                    for j in range(m_saea):
                        grad_single = np.random.choice([ grad_inc_v3, grad_inc_res, grad_inc_v4])
                        ...
                        noise_ensemble = ( noise_inc_res + noise_inc_v3 + noise_inc_v4) / 3
