# coding=utf-8
"""Implementation of SAEA-TI-DIM Attack."""
...
tf.flags.DEFINE_integer('m_saea', 28, 'hyper-parameter of saea, inner iterative number')
            ...
            for filenames, images in load_images(FLAGS.input_dir, batch_shape):
                ...
                for i in range(num_iter):
                    ...
                    for j in range(m_saea):
                        ...
                        grad_single = np.random.choice([ grad_inc_v3, grad_inc_v4, grad_inc_res])
                        # update the choose gradient
